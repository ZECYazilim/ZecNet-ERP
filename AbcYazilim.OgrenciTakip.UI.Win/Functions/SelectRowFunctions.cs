...
namespace AbcYazilim.OgrenciTakip.UI.Win.Functions
{
    public class SelectRowFunctions
    {
        ...
        public BaseEntity GetSelectedRow(int index) => _selectedRows[index];
        public IList<BaseEntity> GetSelectedRows() => _selectedRows;
        public int GetSelectedRowIndex(BaseEntity row) => _selectedRows.IndexOf(row);
